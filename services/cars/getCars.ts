...
export const carSchema = z.object({
  ...
  fuel: z.object({
    type: z.string(),
    economy: z.object({ city: z.number(), highway: z.number() }),
  }),
  acceleration: z.object({ zeroTo60: z.number(), topSpeed: z.number() }),
  ...
  price: z.number(),
  tags: z.array(
    z.object({ value: z.string(), label: z.string(), _id: z.string() })
  ),
