                      ...
                      <div className={`translate transform overflow-hidden ${!open && "hidden"}`}>
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <Link
                              href="/car/add-car"
                              className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white hover:bg-graydark dark:hover:bg-meta-4 ${
                                pathname === "/" && "text-white "
                              } ${pathname.includes("add-car") && "bg-graydark dark:bg-meta-4"}`}
                            >
                              Add Car
                            </Link>
                          </li>
